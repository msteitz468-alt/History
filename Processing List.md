# Processing List — World History Wiki

Prioritized ingestion sequence for Claude Code. All files listed here are present
in the collection. Work through phases in order — each phase builds the structural
skeleton that makes the next phase's material more valuable.

Do not begin a new phase until the previous phase's pages are written, cross-linked,
and index.md is updated. Append a log entry after completing each file.

---

## Instructions for Claude Code

1. All source files are PDFs located in the directory you have been pointed to.
   Treat each file path as relative to the root of the source collection.
2. For each file: read it, extract key historical content, write or update all
   affected wiki pages per CLAUDE.md, update index.md, and append to log.md.
3. Do not ingest files out of phase order. Phase 1 is the structural skeleton —
   everything else depends on it being solid.
4. When you encounter duplicate files (marked with `(1)` or `(2)` suffixes),
   ingest only the first copy. Ignore duplicates.
...
These seven volumes provide the temporal and geographic spine of the entire wiki.
Every subsequent file will attach to pages created here. Do not skip or defer any
of these.

```
1. Prehistory/1. Prehistory/The Cambridge World History/
...
**Expected output**: Period pages for all 24 temporal periods in CLAUDE.md's
framework, populated with global overviews. Process pages for agriculture,
urbanization, state formation, and trade network emergence. This is the wiki's
table of contents in page form.

---

## Phase 2 — Ancient World Reference Backbone

The Cambridge Ancient History is the authoritative multi-volume reference for
antiquity. Ingest in volume order — each volume's coverage builds on the previous.

```
5. Ancient & Classical Civilizations Series/Cambridge Ancient History (14 Books) [Complete]/Cambridge Ancient History (14 Books) [Complete]/
...
## Phase 3 — Medieval World Reference Backbone

```
6. Middle Ages Series/The New Cambridge Medieval History (8 Books) [Complete]/The New Cambridge Medieval History (8 Books) [Complete]/
...
## Phase 4 — Primary Sources: Greek and Roman

These are the voices of the ancient world directly. Ingest after the Cambridge
volumes so actor and event pages already exist for cross-linking.

### Greek Historians and Eyewitnesses
```
5. Ancient & Classical Civilizations Series/Oxford World's Classics/Oxford World's Classics/
...
### Epic and Myth (treat as cultural primary sources, not history)
```
5. Ancient & Classical Civilizations Series/Oxford World's Classics/Oxford World's Classics/
...
## Phase 5 — Primary Sources: Late Antique and Early Medieval

The Translated Texts for Historians series is the primary source backbone for
Late Antiquity and the Early Middle Ages. These are translated chronicles,
letters, synod records, and administrative documents — the raw material of
the period 284–750 CE.
...
## Phase 6 — Primary Sources: East Asian Classics

```
6. Middle Ages Series/Translations from the Asian Classics (100 Books)/Translations from the Asian Classics (100 Books)/
...
## Phase 7 — Ancient Near East and Egypt Depth
...
## Phase 9 — Greece and Rome Depth

### Greece
```
2. Ancient & Classical Civilizations/Ancient Greece/Ancient Greece/
  [All files in 1. Archaic Period section]
  [All files in 2. Classical Period section]
  [All files in 3. Hellenistic Period section]
2. Ancient & Classical Civilizations/Ancient Greece/Ancient Greece/Athens/
  [All files]
2. Ancient & Classical Civilizations/Ancient Greece/Ancient Greece/Sparta/
  [All files]
2. Ancient & Classical Civilizations/Ancient Greece/Ancient Greece/Mycenaean/
  [All files]
```

### Rome
```
2. Ancient & Classical Civilizations/Roman Empire & History/Roman Empire & History/Classical and Early Rome/
  [All files]
2. Ancient & Classical Civilizations/Roman Empire & History/Roman Empire & History/Imperial Rome/
  [All files]
2. Ancient & Classical Civilizations/Roman Empire & History/Roman Empire & History/Fall of Rome/
  [All files]
2. Ancient & Classical Civilizations/Roman Empire & History/Roman Empire & History/Eastern Roman Empire/
  [All files]
2. Ancient & Classical Civilizations/Roman Empire & History/Roman Empire & History/Economy/
  [All files]
```

---

## Phase 10 — Medieval Specialist Series

### Medieval Islamic World
```
6. Middle Ages Series/Early and Medieval Islamic World (7 Books) [Complete]/
  [All files]
6. Middle Ages Series/Edinburgh Studies in Classical Islamic History and Culture (17 Books)/
  [All files]
6. Middle Ages Series/Routledge The Formation of the Classical Islamic World (48 Books)/
  [All files — prioritize any covering Umayyad, Abbasid, and early Caliphate]
```

### Byzantine Empire
```
6. Middle Ages Series/Oxford Studies in Byzantium (25 Books)/
  [All files]
6. Middle Ages Series/Brill's Companions to the Byzantine World (7 Books)/
  [All files]
6. Middle Ages Series/Translated Texts for Byzantinists (10 Books)/
  [All files]
6. Middle Ages Series/New Approaches to Byzantine History and Culture (13 Books)/
  [All files]
```

### Viking and Norse
```
5. Ancient & Classical Civilizations Series/Boydell & Brewer Studies in Old Norse Literature (8 Books)/
  [All files]
6. Middle Ages Series/Viking Society for Northern Research/
  [All files]
6. Middle Ages Series/Islandica (61 Books)/
  [All files — prioritize saga translations over scholarly apparatus]
```
...
3. Middle Ages/Crusades/
  [All files]
6. Middle Ages Series/Routledge Crusades (19 Books)/
  [All files]
6. Middle Ages Series/Routledge Crusade Texts in Translation (33 Books)/
  [All files]
6. Middle Ages Series/Brepols Outremer (13 Books)/
  [All files]
```

---

## Phase 11 — Prehistoric and Archaeological Depth

```
1. Prehistory/1. Prehistory/Paleolithic/
  [All files]
1. Prehistory/1. Prehistory/Neolithic/
  [All files]
1. Prehistory/1. Prehistory/Mesolithic/
  [All files]
1. Prehistory/1. Prehistory/Bronze Age/
  [All files — flag Bronze Age Collapse sources for controversy page]
1. Prehistory/1. Prehistory/Iron Age/
  [All files]
1. Prehistory/1. Prehistory/Ice Age/
  [All files]
1. Prehistory/1. Prehistory/Europe & Asia/
  [All files]
```

---

## Phase 12 — Early Modern Period

```
4. Modern Times/4. Modern Times/4. Modern Times/
  ...
  Pieter C. Emmer, Jos J. J. Gommans - The Dutch Overseas Empire, 1600–1800.pdf
  [All remaining files in this section]
4. Modern Times/4. Modern Times/4. Modern Times/Asia/
  [All files]
4. Modern Times/4. Modern Times/4. Modern Times/Britain/
  [All files]
4. Modern Times/4. Modern Times/4. Modern Times/France/
  [All files]
```

---

## Phase 13 — Specialist Series: Remaining High-Value Sections

Process these after all above phases are complete. Each section deepens existing
pages rather than creating new structural ones.

```
5. Ancient & Classical Civilizations Series/Brill's Culture and History of the Ancient Near East (118 Books)/
5. Ancient & Classical Civilizations Series/Hellenistic Culture and Society (58 Books)/
5. Ancient & Classical Civilizations Series/Oxford Early Christian Studies (101 Books)/
5. Ancient & Classical Civilizations Series/Brill's Religions in the Graeco-Roman World (194 Books)/
6. Middle Ages Series/Brill's Studies in Intellectual History (326 Books)/
6. Middle Ages Series/Cambridge Studies in Medieval Life and Thought Fourth Series (118 Books)/
6. Middle Ages Series/Brill's Studies in Medieval and Reformation Traditions (225 Books)/
6. Middle Ages Series/Brill's Medieval Mediterranean (124 Books)/
6. Middle Ages Series/The New Middle Ages (238 Books)/
```

---

## Duplicate Files — Skip These

The following are confirmed duplicates. Ingest only the version without `(1)` or `(2)`:

- Cambridge World History Vol 6 — skip `(1)` copy
- Cambridge World History Vol 7 — skip `(1)` copy
- New Cambridge Medieval History Vol 2 — skip `(1)` copy
- New Cambridge Medieval History Vol 3 — skip `(1)` copy
- New Cambridge Medieval History Vol 4 Part 1 — skip `(1)` copy
- New Cambridge Medieval History Vol 4 Part 2 — skip `(1)` copy
- New Cambridge Medieval History Vol 5 — skip `(1)` copy
- New Cambridge Medieval History Vol 6 — skip `(1)` copy
- Cambridge Ancient History Vol 02, Part 02 — skip `(2)` copy
- Amélie Kuhrt - The Persian Empire — skip `(2)` copy
- Marc Van De Mieroop - The Ancient Mesopotamian City — skip second copy
- Dietz Otto Edzard - Gudea and his Dynasty — skip `(2)` copy
- Harold David Roth - Original Tao — skip second copy
- Alan K. Bowman - Egypt after the Pharaohs — skip non-Revised Edition copy
