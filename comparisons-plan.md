...
- **Early Civilizations in Comparative Perspective** (Trigger 2003) created as `early-civilizations-in-comparative-perspective.md`. Broad cross-civilizational structural comparison of 7 early civilizations (sociopolitical forms especially city-state vs territorial state; economy; cognitive/symbolic systems with emphasis on shared religious ontology and sacrifice). Links to the existing early-cities page (thematic overlap on urbanism/power) and the Trigger source page. Comparisons section now at **17 pages**. Back-links added; source page synthesis updated to point here.
