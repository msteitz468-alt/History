---
title: The Constitutio Antoniniana (Antonine Constitution)
date_start: 212
date_end: 212
date_precision: year
...
# The Constitutio Antoniniana (Antonine Constitution)

The **Constitutio Antoniniana** of **AD 212** was the edict by which the emperor
[[caracalla|Caracalla]] granted **Roman citizenship to virtually all free inhabitants of the
empire**. Discussed in [[bowman-cah-v12-2005|CAH XII]] Ch. 1 (**Brian Campbell**), who calls it "the
greatest enigma of the reign."

## Narrative

Caracalla extended the Roman franchise to (nearly) all the free population of the provinces — the
culmination of a centuries-long process of enfranchisement that had been gradual under the Republic
and High Empire. The edict survives only in part, in a Greek translation on a papyrus (P. Giss. 40);
its exact terms and the dating (212 or 213) are debated, as is a possible exclusion of a category
(the *dediticii*).
...
- **Cassius Dio's cynical view**: Caracalla wished to widen the tax base, since the inheritance and
  ...
  easier ways to raise revenue, and Dio is hostile.
- **An act of grand patronage**: Caracalla's own words suggest an **effusive thanksgiving** for a
  great occasion (the coup against Geta, or rescue from shipwreck), in the Roman tradition of extending
  citizenship as a reward — the emperor as universal patron. The **absence of the grant from the
  coinage** supports this ephemeral, gestural reading.

## Consequence Analysis

The edict's **practical impact was muted**. By 212 the value of citizenship was already declining,
because the legal distinction that increasingly mattered was not citizen/non-citizen but the **status
divide between *honestiores* and *humiliores*** — which governed punishments and privileges
regardless of citizenship. In the long run, however, the edict completed the **transformation of the
empire's free population into Romans**, with consequences for law, naming, taxation, and identity
