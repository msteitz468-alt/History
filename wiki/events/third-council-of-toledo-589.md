...
region: [mediterranean-world, iberia, western-europe]
location: "Toledo, Spain"
actors_primary: ["[[reccared-i|King Reccared I]]"]
actors_secondary: ["[[leovigild]]", "[[leander-of-seville|Leander of Seville]]"]
...
```mermaid
graph TD
    A["Third Council of Toledo (589)"] -->|End of Arianism| B["Visigothic Catholic Monarchy"]
    B -->|Episcopal Alliance| C["Bishops as State Judges"]
    B -->|Unified Law| D["Liber Iudiciorum (7th c.)"]
    B -->|Theological Shift| E["Filioque Clause in Creed"]
    B -->|Social Pressure| F["Anti-Jewish Legislation"]
```
