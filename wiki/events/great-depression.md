...
worldwide slump of the 1930s, triggered by the **Wall Street Crash of October 1929**, that
brought mass unemployment, the collapse of world trade, and political upheaval that fed the
rise of **fascism** and the road to the Second World War. From
[[new-cambridge-modern-history-v12|*The New Cambridge Modern History*, Vol. XII]].

> Reading note: grounded in NCMH XII's recurring treatment of "the American slump on Wall
> Street in October 1929," the German inflation and "world-wide slump," and the global reach of
> the slump (it reached even South-East Asia), plus established economic history; the dedicated
> economic chapter was not read in full (a lighter-read within this deeper-mode cycle).
...
prices collapsed; unemployment reached a quarter or more of the workforce in the US and
Germany. Recovery was uneven and incomplete until rearmament and war.

## Causal Analysis

- `caused_by:` the **Wall Street Crash** and the structural weaknesses of the 1920s economy
  (over-extended credit, agricultural overproduction, the unstable
  reparations–war-debt–American-lending chain).
- `contributed_to:` the **rigid gold standard**, which forced deflationary policies and
  transmitted the slump internationally; and the **collapse of world trade** as states raised
  tariffs (Smoot-Hawley) and pursued autarky.

## Consequence Analysis

- `produced:` **mass unemployment and social misery**, and a collapse of confidence in liberal
  capitalism and the orthodox economics of balanced budgets.
- `produced:` a turn to **state intervention and economic nationalism** — the American **New
  Deal**, managed currencies, autarky, and the intellectual revolution of **Keynesian**
  economics.
- `enabled:` the **rise of fascism and Nazism** — the Depression destroyed the Weimar Republic
  and brought **Hitler** to power (1933) — and thus the road to the **[[second-world-war-1939|Second
  World War]]** (see [[communism-and-fascism]]).
- Accelerated the relative decline of the European-centred liberal order and the shift of
  economic power to the United States.

## Actors

- The **United States** (the epicentre and then the New Deal) and the **industrial economies**;
  the world's **governments and central banks**; the **unemployed** masses; and the **fascist
  and authoritarian movements** that exploited the crisis. See [[communism-and-fascism]].
