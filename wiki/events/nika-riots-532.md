---
title: The Nika Riots (532)
date_start: 532-01-13
date_end: 532-01-18
date_precision: exact
period: [Late Antiquity]
region: [mediterranean-world, anatolia]
location: "Constantinople"
actors_primary: ["[[justinian|Justinian I]]", "[[belisarius|Belisarius]]", "[[theodora|Empress Theodora]]"]
actors_secondary: ["[[john-the-cappadocian|John the Cappadocian]]", "[[tribonian|Tribonian]]", "[[hypatius|Hypatius]]"]
...
```mermaid
graph TD
    A["Chariot Faction Rivalry (Blues & Greens)"] -->|Sanctuary Escape| D["Nika Uprising (Jan 532)"]
    B["Fiscal Oppression (John the Cappadocian)"] -->|Urban Discontent| D
    C["Senatorial Opposition to Centralization"] -->|Proclamation of Hypatius| D
    D -->|Hippodrome Massacre| E["Autocratic Consolidation"]
    D -->|City Fire| F["Rebuilding Program (Hagia Sophia)"]
```
