---
title: The Justinianic Plague (541–542)
date_start: 541
date_end: 542
date_precision: year
...
```mermaid
graph TD
    A["Plague Epidemic (541-542)"] -->|Mass Mortality| B["Demographic Collapse"]
    B -->|Labor Scarcity| C["Agricultural Decline (Agri Deserti)"]
    B -->|Fewer Taxpayers| D["Fiscal Crisis"]
    B -->|Shrinking Recruit Pool| E["Military Depletion"]
    E -->|Vulnerability| F["Lombard & Arab Conquests"]
```
