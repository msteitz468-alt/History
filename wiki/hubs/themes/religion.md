...
filters:
  and:
    - 'process_type.contains("religious") or event_type.contains("religious")'
views:
  - type: table
    name: religion pages
    order:
...
> need a `religion` tag normalized into their frontmatter, or the filter expression adjusted to your
