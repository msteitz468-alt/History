...
tags: [hub, region, western-europe]
---
...
## All Western Europe pages (live)

```base
filters:
  and:
    - 'tags.contains("western-europe")'
views:
  - type: table
    name: Western Europe pages
    order:
      - title
      - date_start
      - period
...
> need a `western-europe` tag normalized into their frontmatter, or the filter expression adjusted to your
