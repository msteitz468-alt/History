---
title: "Australia — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, australia]
---
...
## All Australia pages (live)

```base
filters:
  and:
    - 'tags.contains("australia")'
views:
  - type: table
    name: Australia pages
    order:
      - title
      - date_start
      - period
...
> need a `australia` tag normalized into their frontmatter, or the filter expression adjusted to your
