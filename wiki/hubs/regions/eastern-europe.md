---
title: "Eastern Europe — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, eastern-europe]
---

# Eastern Europe — Regional Hub
...
## All Eastern Europe pages (live)

```base
filters:
  and:
    - 'tags.contains("eastern-europe")'
views:
  - type: table
    name: Eastern Europe pages
    order:
      - title
      - date_start
      - period
...
> need a `eastern-europe` tag normalized into their frontmatter, or the filter expression adjusted to your
