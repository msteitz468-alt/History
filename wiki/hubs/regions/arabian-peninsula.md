---
title: "the Arabian Peninsula — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, arabian-peninsula]
---

# the Arabian Peninsula — Regional Hub
...
## All the Arabian Peninsula pages (live)

```base
filters:
  and:
    - 'tags.contains("arabian-peninsula")'
views:
  - type: table
    name: the Arabian Peninsula pages
    order:
      - title
      - date_start
      - period
...
> need a `arabian-peninsula` tag normalized into their frontmatter, or the filter expression adjusted to your
