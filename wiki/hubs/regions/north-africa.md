---
title: "North Africa — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, north-africa]
---
...
## All North Africa pages (live)

```base
filters:
  and:
    - 'tags.contains("north-africa")'
views:
  - type: table
    name: North Africa pages
    order:
      - title
      - date_start
      - period
...
> need a `north-africa` tag normalized into their frontmatter, or the filter expression adjusted to your
