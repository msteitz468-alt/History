...
## All South Asia pages (live)

```base
filters:
  and:
    - 'tags.contains("south-asia")'
views:
  - type: table
    name: South Asia pages
    order:
      - title
      - date_start
      - period
...
> need a `south-asia` tag normalized into their frontmatter, or the filter expression adjusted to your
