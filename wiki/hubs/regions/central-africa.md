...
tags: [hub, region, central-africa]
---

# Central Africa — Regional Hub
...
## All Central Africa pages (live)

```base
filters:
  and:
    - 'tags.contains("central-africa")'
views:
  - type: table
    name: Central Africa pages
    order:
      - title
      - date_start
      - period
...
> need a `central-africa` tag normalized into their frontmatter, or the filter expression adjusted to your
