...
## All Southeast Asia pages (live)

```base
filters:
  and:
    - 'tags.contains("southeast-asia")'
views:
  - type: table
    name: Southeast Asia pages
    order:
      - title
      - date_start
      - period
...
> need a `southeast-asia` tag normalized into their frontmatter, or the filter expression adjusted to your
