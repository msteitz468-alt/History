---
title: "Sub-Saharan Africa — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, sub-saharan-africa]
---

# Sub-Saharan Africa — Regional Hub
...
## All Sub-Saharan Africa pages (live)

```base
filters:
  and:
    - 'tags.contains("sub-saharan-africa")'
views:
  - type: table
    name: Sub-Saharan Africa pages
    order:
      - title
      - date_start
      - period
...
> need a `sub-saharan-africa` tag normalized into their frontmatter, or the filter expression adjusted to your
