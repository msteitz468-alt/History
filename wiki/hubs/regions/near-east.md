---
title: "the Near East — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, near-east]
---

# the Near East — Regional Hub
...
## All the Near East pages (live)

```base
filters:
  and:
    - 'tags.contains("near-east")'
views:
  - type: table
    name: the Near East pages
    order:
      - title
      - date_start
      - period
...
> need a `near-east` tag normalized into their frontmatter, or the filter expression adjusted to your
