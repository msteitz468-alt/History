---
title: "Southern Africa — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, southern-africa]
---
...
## All Southern Africa pages (live)

```base
filters:
  and:
    - 'tags.contains("southern-africa")'
views:
  - type: table
    name: Southern Africa pages
    order:
      - title
      - date_start
      - period
...
> need a `southern-africa` tag normalized into their frontmatter, or the filter expression adjusted to your
