---
title: "the British Isles — Regional Hub"
hub_type: region
last_updated: 2026-06-22
tags: [hub, region, british-isles]
---

# the British Isles — Regional Hub
...
## All the British Isles pages (live)

```base
filters:
  and:
    - 'tags.contains("british-isles")'
views:
  - type: table
    name: the British Isles pages
    order:
      - title
      - date_start
      - period
...
> need a `british-isles` tag normalized into their frontmatter, or the filter expression adjusted to your
