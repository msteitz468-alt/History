...
## All West Africa pages (live)

```base
filters:
  and:
    - 'tags.contains("west-africa")'
views:
  - type: table
    name: West Africa pages
    order:
      - title
      - date_start
      - period
...
> need a `west-africa` tag normalized into their frontmatter, or the filter expression adjusted to your
