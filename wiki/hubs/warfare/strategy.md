...
- [[friedman-b-a|Friedman]] — modern tactical theory: 9 tenets (physical/mental/moral planes targeting moral cohesion) + explicit link between tactics and strategy. Primary text: [[sources/friedman-on-tactics-2017]]. Provides clear doctrinal scaffolding (Maneuver, Mass, Firepower, Tempo, Deception, Surprise, Confusion, Shock, Moral Cohesion) and concepts (culminating point, initiative, C2) for battle analyses. Critiques operational level as artificial barrier and emphasizes strategy dictates tactical form.
