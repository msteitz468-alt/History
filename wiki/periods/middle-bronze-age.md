...
The **Middle Bronze Age** (~2,100–1,550 BCE in the Near East) is the era of the
**second urbanization** and the consolidation of **territorial states and palace
economies** across the Fertile Crescent, after the fragmentation that closed the
[[early-bronze-age|Early Bronze Age]]. It is dominated by two great recoveries —
...
- **The Ur III revival (~2112–2004 BCE)** — after the [[gutian-invasion|fall of
  Akkad]] and Utu-khegal's liberation, [[ur-nammu|Ur-Nammu]] and [[shulgi|Shulgi]]
  build the [[third-dynasty-of-ur|Third Dynasty of Ur]], a centralized, intensely
  **bureaucratic** Sumerian state (the largest archival corpus of the ancient
...
- **The Egyptian Middle Kingdom (~2040–1650 BCE)** — the
  ...
  [[first-intermediate-period|First Intermediate Period]]; the
  [[middle-kingdom-egypt|Eleventh and Twelfth Dynasties]] build a classic age of
  Egyptian state, art, and literature, conquer **Lower Nubia** with a chain of
  fortresses, and reclaim the **Faiyum**. [[senwosret-iii|Senwosret III]] breaks
  the provincial nomarchs.
- **The Amorite ascendancy** — the [[amorites|Amorites]] (Sumerian *martu*, Akkadian
  *amurru*), long infiltrating from the Syrian steppe, become the dominant political
  force: Ur III builds a "Wall against Amurru," then falls to them; Amorite dynasts
  take over the cities of Mesopotamia and Syria, founding the kingdoms that
  Hammurabi's Babylon will later unify.
- **The second urbanization of the Levant** — after a non-urban
  [[first-intermediate-period|EB–MB intermediate]] interlude (Kenyon: nomadic
...
**Additional detail from Bogucki & Crabtree (eds.), Ancient Europe (2004) Range 01 (Part 5):** In temperate southeastern Europe the MBA (~1800/1500 B.C. onward) is marked by preference for cremation rather than inhumation, increase of metal objects/weapons in graves and hoards, and stronger tendency to place sites on defensible locations often surrounded with walls. "These changes were long explained as betokening times of more unrest. More recent studies have emphasized the multiple possible reasons for these phenomena, including gradual development of chiefly or tribal societies, emulation of developing Mediterranean societies, economic and social changes that promoted an ideology of male display (involving weapons, but not necessarily large-scale or widespread warfare), changes in metallurgy and technology, or shifts in religious beliefs." Examples: Incrusted Ware (central Hungary), Vatya, Fuzesabony, Otomani, Tei, Vatin. Feudvar (near Mosorin) illustrates: palisaded wattle-and-daub settlement, rectangular houses up to 12×6 m with interior hearths/storage, Vatin fine incised pottery, mixed farming (wheat/barley/beans/legumes, bronze/flint sickles; possible beer), hunting/fishing, elaborate bone/horn/antler work with concentric/meander designs. Settlements typically small hamlets/farmsteads; largest (e.g. Feudvar, Zidovar) perhaps ~100+ people. 

In central Europe MBA shows dispersed settlement, increased pastoralism/transhumance, and ritual hoarding as gift exchange with gods (weapons deposited in rivers/lakes/fens/caves over long periods at interregional sacred sites; e.g. Berlin-Spandau pier with distant swords/daggers). Agriculture intensified with secondary products emphasis. 

Italian sequences (Apennine/MBA continuation into Recent BA): transhumant pastoralism integrated with lowland mixed farming; terremare in central Po Plain expand dramatically (Santa Rosa di Poviglio to 7 ha; Fondo Paviani 16 ha; Case del Lago 22.5 ha); some with inner "keeps"; ritual metal deposition in rivers. Collapse of palafitte-terremare system ~1200 B.C. (contemporaneous with eastern Med palace collapse; eastern weights attested). Final BA sees Protovillanovan urnfields, Frattesina (20 ha craft/trade center with glass, ivory, bronze, iron, amber working and LH IIIC imports). 

Iberia: El Argar and related (Bronce Valenciano, Mancha BA) show mixed farming with plow and secondary products; Argaric has distinctive chalices/swords/halberds in burials (scarce in some areas); Mancha circular fortified settlements (El Azuer, El Acequión); segmentary organization inferred from settlement patterns (small sites dominant). Sardinia: Nuragic towers (~7,000, 2000–600 B.C.) as monumental corbeled domestic/watch/fortress structures on dispersed farmsteads; "giants’ tombs" for communal burial; local stone (basalt/granite); construction required cooperation (~3,600 person-days per tower). 
...
Historically active: Mesopotamia, Egypt and Nubia, the Levant, Syria, Anatolia
(via the Assyrian colonies), and the Iranian plateau (Elam). The Aegean (Minoan
Crete's first palaces) and the Indus develop in parallel; long-distance exchange
links them all (the **Tod Treasure** in Egypt contains Aegean silver and
Mesopotamian cylinder-seals).

## Transition

Follows the [[early-bronze-age|Early Bronze Age]] across the ~2,200–2,000 BCE
horizon of collapse and reformation (the fall of Akkad, the Egyptian First
Intermediate Period, the EB–MB break in the Levant). Closes toward the
[[late-bronze-age|Late Bronze Age]] with the Hyksos in Egypt, the rise of the
...
cuneiform (the vast Ur III bureaucratic archives; the later Mari archives), and in
Egypt a "golden age" of literary and didactic texts (the *Instruction for
Merykare*, the *Prophecy of Neferty*, the *Story of Sinuhe*, the *Instruction of
Ammenemes I*) that are simultaneously historical sources and royal propaganda.
Egyptian chronology rests on the king-lists (the Turin Canon), regnal dates, and
co-regency reckoning.

**Debates.** Whether the Twelfth Dynasty's reach into Syria-Palestine amounts to an
"**empire**" or only diplomatic-commercial influence (Posener: an "uneven but
vigorous" informal domination, evidenced by sphinxes at Ugarit/Qatna, resident
officials at Byblos and Megiddo, and the geographic detail of the **Execration
Texts** — though those are ritual, not a political map); the **Amorite question**
(invaders vs. long-term infiltrators; the scale of their role in the fall of Ur);
