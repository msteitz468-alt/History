...
**Teotihuacan**, in the Basin of Mexico, was the largest city of the ancient
Americas — a **"primate" center** of **>100,000 people** over a planned
**20 km²** urban zone, capital of a regional state from the 1st century BCE to
its violent end ~650 CE. It is the case study of [[yoffee-cwh-v3-2015|CWH Vol.
III]] Ch. 13 (Sarah Clayton), exemplary for its **planning, ethnic/social
diversity, and anonymous rulership**, and the volume's best-mapped city (the
Teotihuacan Mapping Project, René Millon, 1962–).

## Form and planning

A monumentally orderly grid oriented **15.5° east of north**, organized around
the 5 km **Avenue of the Dead** running to the **Pyramid of the Moon**, with the
**Pyramid of the Sun** and the **Ciudadela** (enclosing the Feathered Serpent
Pyramid). The avenue was the processional and civic spine, within the daily
viewshed of the whole population — a constant materialization of state power and
shared **Teotihuacano identity**.

## Anonymous rulership

Strikingly, Teotihuacan produced **no depictions of named rulers** and **no
identified royal tomb** — unlike the [[tikal|Maya]] cult of the king. This
suggests a distinctive, possibly **collective or council-based** government
(some argue an originating **synoikism** of formerly autonomous groups, perhaps
later subverted by strong rulers). Monuments yielded mass **human sacrifice** of
decorated warriors, evidencing military power. A genuine case for
[[heterarchy|heterarchical]] or corporate governance.

## Apartment compounds and diversity

Most residents lived in ~**2,300 walled apartment compounds** (60–100 people
each), built in a state-initiated "urban renewal" (~200–275 CE) yet varying in
size, status, and orientation — some accretional and non-conforming (Tlajinga
33), implying compound-level autonomy. Compounds map onto **barrios**
(neighborhoods), craft specializations (obsidian, pottery, lapidary), and
**ethnic enclaves** (the Oaxaca/Zapotec enclave; a Merchants' barrio). The
"house" model and intra-compound burial link identity to residence.

## Ruralization and the region

Clayton stresses Teotihuacan as a **regional phenomenon**: "the urbanization of
Teotihuacan was concurrently a process of **ruralization** of the surrounding
region." Hinterland villages (e.g. Axotlan, ~800 people) adopted urban apartment-
compound forms and the 15.5° orientation, integrated into the state's class
structure yet differing (e.g. in gendered mortuary practice). See [[ruralization]].

## Why this place mattered

Teotihuacan is the great American case of a **planned, multiethnic, collectively
governed metropolis** — the structural opposite of the Maya dedicated city and a
key comparand to [[uruk|Uruk]] and [[tiwanaku|Tiwanaku]]. Yoffee notes that
Teotihuacan can be mapped in ways that fill Mesopotamian archaeologists "with
wonder and envy."

## In CWH IV: the obsidian trade hub and its collapse

[[benjamin-cwh-v4-2015|CWH IV]] (Begun & Brashler, Ch 20) adds the **economic and
network** dimension, treating Teotihuacan as the central node of Classic-period Mesoamerican
exchange. Its rise rested on control of the **Pachuca green-obsidian** source (prized for its
green-gold color and quality); Teotihuacano obsidian and iconography reached the Gulf Coast,
Oaxaca, the Maya region, and beyond. CWH IV reads this reach as **economic rather than
conquest-based**, evidenced by Teotihuacano imagery (butterflies, atlatl spear-throwers) at
**[[zapotec|Monte Albán]]** and the Maya cities of **Copán** and **Tikal**, and by probable
**marriage ties** with their ruling dynasties.

The **collapse (c. 600–650 CE)** is given a network explanation: as trade costs rose at the
edges of the system, cheaper green-obsidian sources opened in the Maya region and Michoacán,
