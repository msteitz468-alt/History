...
period_coverage: [Deep Prehistory, Behavioral Modernity, Neolithic, Early Iron Age, Classical Antiquity, Late Antiquity, Early Middle Ages, High Middle Ages, Late Middle Ages, Early Modern, Age of Expansion, Long 19th Century, World Wars Era, Cold War]
region_coverage: [sub-saharan-africa, north-africa, east-africa, west-africa, central-africa, southern-africa, horn-of-africa]
methodological_approach: [narrative, environmental, archaeological, social]
reliability_notes: >
  A celebrated single-volume "biography" of the whole continent by a journalist-scholar, organized around
  an environmental and deep-time argument: Africa's geology, soils, climate, and disease ecology as the
  shaping constraints on its human history. Authoritative and synthetic at the scale of the continent, but
  it is a 1997 narrative — strong on the long run (geology, human origins, ecology, the slave trade,
...
John Reader's *Africa: A Biography of the Continent* (1997) is the **synthetic spine** for the wiki's
Sub-Saharan Africa gap (**Gap 2**) — a single-volume history of the entire continent across deep time,
organized around an **environmental argument**: that Africa's ancient geology, thin and fragile soils,
capricious climate, and uniquely heavy **disease burden** (malaria, trypanosomiasis) set the constraints
within which its peoples built their societies, and that this ecological reality — not any cultural
deficiency — explains the distinctive paths of African history. As the birthplace of humanity, Africa is
also where the deepest human history is written.

This is the foundational, continent-wide source; the **[[reader-africa-biography#Section Plan|Section
Plan]]** below governs its Large-Volume ingest. The eight UNESCO **General History of Africa** volumes,
the **West Africa** reference, and the primary sources (**Sundiata**, **Ibn Battuta**) will deepen the
state-level pages this spine creates.
...
**Section 4 — African Civilizations (chs. 20–30), processed 2026-06-12:**
- **Created:** [[sub-saharan-africa]] (the regional anchor + Reader's environmental thesis);
  [[great-zimbabwe]] (the cattle-and-gold thesis; Mapungubwe → Great Zimbabwe → Mutapa).
- **Updated:** [[jenne-jeno]] (the ecological reading of non-coercive urbanism); [[aksum]] (indigenous
  ...
  environmental collapse; refutation of the "Nile corridor" diffusionism); [[swahili-coast]] (Sofala and
  the gold of the interior).
- *Trans-Saharan gold trade and African disease ecology (chs. 24, 26, 28) substantially overlap existing
  pages — to fold a Reader note into [[trans-saharan-trade]] in the synthesis pass.*

**Section 5 — Foreign Influences (chs. 31–39), processed 2026-06-12:**
- **Created:** [[impact-of-atlantic-slave-trade-on-africa]] (the Lovejoy/Manning transformation-and-
  depopulation thesis vs the Eltis/Thornton minimization; the gun–slave cycle dispute — a `[CONTRADICTION]`
  with the Thornton-based main page).
- **Updated:** [[atlantic-slave-trade]] (Reader's African petty-trader supply side — Miles, Antera Duke;
  the cowrie currency; the gun–slave cycle; Manning's demographic catastrophe; maize and cassava).
