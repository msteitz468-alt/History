---
title: "The Oxford Handbook of Modern German History"
author: [Helmut Walser Smith (editor)]
year: 2011
...
# The Oxford Handbook of Modern German History (Smith, ed., 2011)

Multi-author OUP handbook, 35 chapters, covering German history from the Holy Roman Empire's
last century (c. 1760) to the post-reunification Berlin Republic. Thematic and historiographical
rather than narrative. Editor Helmut Walser Smith frames the volume around the collapse of the
**Sonderweg** ("special path") paradigm and the search for what should replace it — reading German
history as connected (transnational, colonial, European) rather than uniquely deviant, while
keeping the catastrophe of 1933–45 at the analytical centre.

Ingested via the **deployed-subagent strategy** (CLAUDE.md). Substantive text: lines **503–13,513**
of the raw `.txt`; lines 13,514+ are Bibliography and Index.

## Naming conventions (established for this ingest)

- **States** (actors, `state`): `german-confederation` (1815–66), `north-german-confederation` (1867–71),
  `german-empire` (Kaiserreich, 1871–1918), `weimar-republic` (1918–33), `nazi-germany` (Third Reich,
  1933–45), `west-germany` (FRG), `east-germany` (GDR), `prussia`. Reunified Germany → use
  `[[german-reunification-1990]]` (event) + existing `[[german-unification]]` (1871 narrative).
- **Persons** (actors, `person`): full kebab name — `otto-von-bismarck`, `wilhelm-ii`, `adolf-hitler`,
  `frederick-the-great`, `konrad-adenauer`, `willy-brandt`, `helmut-kohl`.
- **Events** (`[name]-[year]`): `austro-prussian-war-1866`, `franco-prussian-war-1870`,
  `november-revolution-1918`, `kristallnacht-1938`, `fall-of-the-berlin-wall-1989`,
  `german-reunification-1990`. (Link existing `[[revolutions-of-1848]]`, `[[first-world-war-1914]]`,
  `[[second-world-war-1939]]`, `[[the-holocaust]]`, `[[berlin-blockade-1948]]`.)
- **Processes**: `kulturkampf`, `german-industrialization`. **Concepts/controversies**: the
  `[[german-sonderweg]]` debate (controversy).

## Scaffold pages (created on the main thread; agents LINK, never recreate)

`prussia` · `german-confederation` · `german-empire` · `weimar-republic` · `nazi-germany` ·
`otto-von-bismarck` · `german-sonderweg` (controversy). Plus existing link targets above.

## Section Plan — 6 agents, disjoint line-ranges

Each agent owns a contiguous era → a distinct page set (no file collisions). Cross-era backbone
pages are scaffolded above; agents link to them.

| Agent | Lines | Chapters | Period(s) | Owns (creates) |
|---|---|---|---|---|
| **A** Foundations → Napoleonic | 503–3038 | 1–6: Introduction; Origins of Modern Germany; Senses of Place; Women & Men 1760–1960; War & the Making of Germany 1740–1815; Cosmopolitanism & the German Enlightenment | Early Modern, Age of Expansion | `german-enlightenment`, `frederick-the-great`, Frederician/Napoleonic war pages; enrich `[[holy-roman-empire-late-medieval]]`, `[[prussia]]` |
| **B** Vormärz, nationalism, economy | 3039–5154 | 7–12: Atlantic Revolutions in the German Lands 1776–1849; End of the Economic Old Order 1750–1860; Escaping Malthus (population) 1760–1884; Protestants/Catholics/Jews 1760–1871; Formation of German Nationalism 1740–1850; Literature & Thought 1810–1890 | Age of Expansion, Long 19th Century | `german-nationalism`, `vormarz`, German-Jewish emancipation pages; enrich `[[revolutions-of-1848]]`, `[[nationalism]]`, `[[ashkenazi-jewry]]` |
| **C** Unification & Kaiserreich | 5155–6844 | 13–16: Nation State & Culture War 1850–1878; Authoritarian State … 1878–1914; Great Transformation (economy/society) 1850–1914; Race & World Politics (imperialism) 1878–1914 | Long 19th Century | `kulturkampf`, `austro-prussian-war-1866`, `franco-prussian-war-1870`, `german-colonial-empire`; enrich `[[german-empire]]`, `[[otto-von-bismarck]]`, `[[german-unification]]` |
| **D** WWI, Weimar, Nazi economy | 6845–8098 | 17–19: Germany 1914–1918 Total War; National Economy in Crisis & War 1917–1945; Dictatorship & Democracy 1918–1939 | World Wars Era | `november-revolution-1918`, `german-war-economy`, Weimar-collapse pages; enrich `[[weimar-republic]]`, `[[nazi-germany]]`, `[[first-world-war-1914]]` |
