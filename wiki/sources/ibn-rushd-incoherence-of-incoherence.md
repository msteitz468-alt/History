---
title: "The Incoherence of the Incoherence (Tahāfut al-Tahāfut)"
author: [Ibn Rushd (Averroes)]
year: 1180 (composed); Simon van den Bergh translation, 1954
source_type: primary
...
# The Incoherence of the Incoherence (Ibn Rushd, c. 1180)

Ibn Rushd's point-by-point reply to [[ghazali-incoherence-of-philosophers|al-Ghazālī's Incoherence]],
defending the [[islamic-philosophy|falāsifa]] (chiefly Aristotle) while also correcting
[[ibn-sina|Avicenna]] and faulting al-Ghazālī's dialectics. Ingested as the second half of the
[[philosophy-versus-theology-in-islam|al-Ghazālī ↔ Ibn Rushd controversy]]: agents link the
just-created al-Ghazālī pages ([[eternity-of-the-world]], [[ghazali-on-causality]],
[[god-knowledge-of-particulars]], [[the-three-condemnations]]) and create the corresponding Averroist
replies.

Deployed-subagent strategy, **5 agents** mapped to the Discussions (16 on metaphysics, 4 on physics),
weighted toward the metaphysics and the key causality reply. Body content: lines ~**1,133–15,200** of
`raw/_averroes-wrapped.txt`; later lines are notes/index.

## Naming conventions

- **New pages**: `tahafut-al-tahafut` (the work — scaffolded), `averroes-on-eternity`,
  `averroes-on-creation-and-agency`, `averroes-on-divine-attributes`, `averroes-on-gods-knowledge`,
  `averroes-on-causality`, `averroes-on-resurrection`, `averroes-defense-of-philosophy`.
- LINK existing (never recreate): `ibn-rushd`, `al-ghazali`, `ibn-sina`, `tahafut-al-falasifa`,
  `ghazali-incoherence-of-philosophers`, `eternity-of-the-world`, `ghazali-on-causality`,
  `god-knowledge-of-particulars`, `bodily-resurrection-islam`, `the-three-condemnations`,
  `occasionalism-islamic`, `emanationism-avicennan`, `islamic-philosophy`, `islamic-metaphysics`,
  `aristotelianism`, `unity-of-intellect`.

## Scaffold pages (created on the main thread; agents LINK, never recreate)

`tahafut-al-tahafut` (the work) and `philosophy-versus-theology-in-islam` (the controversy page).

## Section Plan — 5 agents, disjoint line-ranges

| Agent | Lines | Discussions | Owns (creates) |
|---|---|---|---|
| **A** Eternity of the world | 1133–3817 | Metaphysics Disc 1 — the eternity of the world (the longest discussion; Averroes' defense vs al-Ghazālī's refutation) | `averroes-on-eternity`, `tahafut-al-tahafut` (link scaffold) |
| **B** Creation & the divine agent | 3818–7221 | Metaphysics Disc 2–4 — incorruptibility of the world; God as agent; the proof of a creator | `averroes-on-creation-and-agency` |
| **C** Unity, attributes, simplicity | 7222–10400 | Metaphysics Disc 5–11 — God's unity; the divine attributes; simplicity; that the First is incorporeal | `averroes-on-divine-attributes` |
