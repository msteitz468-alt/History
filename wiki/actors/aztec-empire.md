---
title: Aztec Empire (the Triple Alliance)
actor_type: empire
date_start: 1428 CE (formation of the Triple Alliance)
...
# Aztec Empire (the Triple Alliance)

## Overview

The **Aztec Empire** — properly the **Triple Alliance** of [[tenochtitlan|Tenochtitlan]],
Texcoco, and Tlacopan (Tacuba), led by the **Mexica** of Tenochtitlan — was the
largest and most powerful state of Postclassic Mesoamerica, dominating central Mexico
from its formation in **1428** until the Spanish conquest of 1521.
[[kedar-cwh-v5-2015|CWH V]] (Michael E. Smith, Ch 23) presents it as the great
exception to the Postclassic norm: where most Postclassic polities were "smaller,
shorter-lived, and less despotic than those of the Classic period," the Aztec and
Tarascan empires "developed in contradistinction to this trend," building large
tributary empires in the final pre-conquest century.

## The Postclassic Context

Smith's chapter frames the Aztecs within **Postclassic Mesoamerica** (8th–15th c.), a
period that — after the [[societal-collapse-and-environmental-determinism|collapse]] of
[[teotihuacan|Teotihuacan]], [[tikal|the Classic Maya]], and Monte Albán — was "very
dynamic politically with multiple historical trajectories." Peoples migrated,
commercial networks grew in scale and diversity, and a shared **art style and symbol
set** (the "Postclassic international style") spread across Mesoamerica. The Basin of
Mexico, the demographic and political core since Teotihuacan, saw population rebound
to a Late Postclassic peak — the setting for the Aztec rise.

## Structure of the Empire

The Mexica, late-arriving Nahua migrants who founded **Tenochtitlan** on an island in
Lake Texcoco (traditionally 1325), rose from mercenaries to masters of the Basin.
After overthrowing their Tepanec overlords, they formed the **Triple Alliance** in
1428 and, under rulers such as **Moctezuma I** and **Ahuitzotl**, expanded by conquest
across central and southern Mexico. The empire was a **hegemonic, tribute-extracting**
system rather than a territorially administered one: conquered city-states (*altepetl*)
kept their own rulers but rendered tribute (recorded in pictorial codices such as the
*Codex Mendoza*) and provided captives. Its economy ran on intensive *chinampa*
agriculture, vast market exchange (the great market of Tlatelolco), and the
...
The Aztec Empire exemplifies the volume's thesis that **imperial state formation,
monumental urbanism, and long-distance commercial integration arose independently in
the Americas** — a Mesoamerican empire that must be read on its own terms (Smith), not
merely as the foil to the Spanish conquest. Together with the [[inca-empire|Inca]] it
shows the western hemisphere assembling its largest states precisely as the
[[afro-eurasian-world-system|Old World system]] reached its own integrative height —
the two hemispheres still "worlds apart" (Olstein) until 1519.

## The Conquest and the Columbian Exchange (CWH VI)

Noble David Cook (CWH VI) underlines that the Spanish conquest of 1519–21 cannot
be understood apart from the [[columbian-exchange-1492|Columbian Exchange]]. The
**smallpox pandemic** that swept central Mexico in 1520, after reaching the
mainland from the Caribbean, "contributed directly to the Spanish victory over
the Aztecs" — gutting the defenders of Tenochtitlán, killing leaders, and
demoralizing a population for whom the disease was inexplicable. Jeremy Black
(CWH VI) adds the political dimension the [[military-revolution|"military
revolution"]] thesis tends to obscure: Cortés's success owed less to weapons than
to **indigenous disunity and local alliances** (above all with Tlaxcala). The
