...
The **Mongol Empire** (1206–1368, with successor states beyond) was the largest
contiguous land empire in human history, stretching at its height "from Korea to
Hungary, from Burma and Iraq to Siberia." Founded by [[genghis-khan|Chinggis Khan]]
(Temüjin) in 1206, it subsumed under a single Chinggisid dynasty not only the whole
Eurasian steppe but **three settled civilizations** — the Chinese (centre conquered
by 1279), the Islamic (its erstwhile centre [[baghdad|Baghdad]] taken in 1258), and
the Orthodox-Christian outer realms (the Russian principalities, from 1241).
...
## From Steppe Confederation to World Empire

The Mongols arose, in [[kedar-cwh-v5-2015|Arnason's]] reading (Ch 18), within a
**China-centred constellation**: Chinggis Khan's marginal society was a decomposing
former tributary of the Jurchen Jin, heir to the Khitan **Liao** technique of **dual
...
- **eclectic but highly extractive taxation**; and
- the systematic **gathering and redistribution of "human talent and skill as a form
  of booty"** — moving artisans, scholars, administrators, and soldiers across the
  empire.
...
The unified empire (1206–1260) fractured after an intra-dynastic succession conflict
into four regional empires, which nonetheless retained "a strong sense of Chinggisid
unity":
...
The Mongols' reputation runs "the gamut from the 'Tatar Yoke' to the Pax Mongolica."
The destruction was real (the massacres of Nishapur, Merv, Baghdad), and there is "no
reason to pretend it did not happen"; but recent scholarship (Allsen, Biran, Jackson)
stresses the constructive legacy of exchange and integration. Two debates the chapter
notes: whether the empire fell from "overstretch" (Biran thinks its power-maximizing
