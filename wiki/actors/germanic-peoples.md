---
title: The Germanic Peoples (Third Century)
actor_type: movement
date_start: c. 150 CE (the new groupings emerge)
date_end: c. 400 CE (the eve of the migrations — beyond this volume)
period: [Late Antiquity]
region: [western-europe, northern-europe, eastern-europe, eurasian-steppe]
affiliated_with: [the Roman army (as recruits and allies), trans-Rhenane and trans-Danubian Barbaricum]
...
# The Germanic Peoples (Third Century)

The peoples of **Barbaricum** beyond the Rhine and Danube — and, above all, the **new and larger
groupings** (the **Goths, Alamanni and Franks**) that coalesced from the late second century and pressed
ever harder on the Roman frontiers during the [[third-century-crisis|crisis]]. Treated in
[[bowman-cah-v12-2005|CAH XII]] Ch. 13 (**Malcolm Todd**), a chapter constrained by a "pall of near-
silence" in the written sources after Tacitus and dependent heavily on archaeology.

## Ethnogenesis: new groupings, not nations

Todd's central theme is that the small tribes of Tacitus and Ptolemy were, by c. 200, giving way to
**larger confederations** — but these were **not unified ethnic nations**. The question at the heart of
the Franks, Alamanni and Goths is **ethnicity**, and Todd argues their bonds were as much circumstantial
as ethnic: interlinked kin-groups around a loose outer perimeter of marriage, gift-exchange and personal
allegiance, with elites shaped by two centuries of contact with Rome (service in the army, the rewards of
raiding).

- **The Alamanni** (first named at Caracalla's campaign of 213) — an "obvious amalgam" of Hermunduri,
  Semnones, Suebi and others, confronting the Upper German/Raetian *limes*. After breaking through and the
  **abandonment of the *limes* (c. 259/60)** they began **settling the Agri Decumates**, often reusing
  Roman villa and fort sites and building **hilltop chieftains' residences** (the Runder Berg near Urach).
  They remained a **plurality of kings and *reguli***, never unified.
- **The Franks** (first named 253) — "not a distinct people... but a shifting body of inter-related warrior
  groups" east of the lower Rhine (Bructeri, Chamavi, Sugambri and others). The name (probably a Roman
  coining, "the free/brave") covered war-bands that raided Gaul and the Channel, but were as readily
  **recruited into Roman service**; from Constantine, Franks rose to high command in the Roman army.
- **The Goths** — eastern Germani who moved south from the Vistula basin (the **Wielbark culture**) into the
  Ukraine and Black Sea hinterland (the rich **Chernjakhov culture**), raiding Moesia, Dacia, Greece and
  Asia Minor by sea from the 230s–240s. No "cohesive ethnic unit lay behind the name"; their most famous
  leader, **Kniva**, owed authority to military prowess.

## Society, settlement and warfare

- **Settlement**: archaeology (Feddersen Wierde, Wijster, Vorbasse, Hodde) reveals **planned, long-lived
  villages** with clear **social differentiation** — a palisaded *Herrenhof* (chieftain's hall) with
  dependent craftsmen — and steady **population growth**, "one of the major forces which brought about the
  later migrations."
- **Economy**: mixed farming dominated by **cattle**, with barley, rye, millet and oats; large-scale **iron
  production** (the Lysa Gora hills in Poland) far beyond what Roman writers credited.
- **Warfare**: still overwhelmingly **infantry** with spear and shield; the long slashing ***spatha***
  spread, and so many **Roman weapons** reached the north (the votive deposits of Illerup, Thorsbjerg,
  Nydam) that German and Roman swords become hard to distinguish. Germani were poor at **siege warfare** —
  the Gothic attempts on Thessalonica and Side (269) failed — but their **strategic ambitions grew** with
  each frontier breakthrough.
- **Culture and trade**: cross-frontier trade in metalwork, glass and **amber** (and Roman gold/silver
  coin, reaching elite circles especially on **Zealand**) flowed alongside **gift-exchange diplomacy**. The
  third century saw the rise of polychrome **goldwork** and garnet-inlay (setting the fashion for later
  Germanic art) and the first **runic inscriptions** (after c. 150).

## Significance

Todd's conclusion frames the late-second/third-century transformation as **formative**: the new groupings
were "more than tribes, less than early states," and close to the frontier "societies had begun to emerge
