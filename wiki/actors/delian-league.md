---
title: The Delian League (Athenian Empire)
actor_type: organization
date_start: 478/477 BCE (foundation on Delos)
...
The **Delian League** was the alliance of Greek states founded under **[[athens|Athenian]]**
leadership in **478/477 BCE** to continue the war against [[achaemenid-empire|Persia]] after
the [[battle-of-plataea-479bce|Persian Wars]]. Over the following half-century it was
transformed — by stages, the editors stress, and "not necessarily of set purpose" — into the
**Athenian empire**, the maritime, tribute-fed power whose growth Thucydides identifies as
the "truest cause" of the [[peloponnesian-war|Peloponnesian War]].
[[lewis-cah-v5-1992|CAH Vol. V]] (Ch. 3, P. J. Rhodes) reconstructs its history from
Thucydides' compressed *Pentekontaetia* (i.89–118) supplemented by Diodorus, Plutarch, and
above all the **tribute quota-lists** inscribed at Athens from 453.

## Foundation and organization

After the Spartan regent **[[pausanias-regent|Pausanias]]** alienated the allies at Byzantium
(478), the eastern Greeks pressed the leadership on Athens, which had the largest navy and a
claimed kinship with the Ionians. A new, permanent **offensive and defensive alliance** was
sworn — symbolically "to last until lumps of metal rose from the sea." Its structure:

- A treasury and synod on **[[delos|Delos]]** (Ionian Apollo's sanctuary), where allied
  delegates met in a **single council**, each state (Athens included) holding **one vote**.
- Some members contributed **ships**, the majority **cash** (*phoros*, "tribute"), the form
  decided by Athens; the first assessment (traditionally by the Athenian **[[aristides-the-just|Aristides]]**,
  "the Just") totalled **460 talents**. Athens supplied the commanders and the financial
  officials (*hellenotamiai*).
- Because more than half the members could not regularly furnish even one trireme, most
  found it "less burdensome to pay tribute than to campaign" — and ships built from the
  tribute became **Athenian** ships, so the fleet grew at the allies' expense while the
  allies lost the capacity to resist.

## From alliance to empire

Rhodes traces the slide through Thucydides' selective catalogue, which is itself organized to
show "the growth of Athenian power":

- **Legitimate anti-Persian action**: the capture of **Eion** and **Scyros** (with Athenian
  settlers planted), the coercion of medizing **Carystus**, and the great victory at the
  **Eurymedon** (c. 469), which broke a Persian fleet and army in one day.
- **Coercion of allies**: the suppression of the revolts of **Naxos** ("the first allied
  state to be enslaved contrary to what had been established") and **Thasos** (465–463, over
  Thracian mines Athens coveted) — walls demolished, warships surrendered, indemnity and
  tribute imposed. Thasos appealed to Sparta, but Sparta was paralysed by the great
  **earthquake and Helot Revolt** of 464.
- **Overreach**: the **Egyptian expedition** (c. 459–454) in support of the rebel
  **Inaros** ended in disaster, with a large League fleet destroyed by Persia — the shock
  that prompted the **transfer of the treasury from Delos to Athens** (454/3) "in fear of
  Persian reprisals."

## The mid-century crisis and the marks of empire

The defection that followed the Egyptian disaster drove Athens to coercive controls the
quota-lists reveal and Thucydides omits: imposed **democratic constitutions** (Erythrae,
Miletus), Athenian **overseers** (*episkopoi*) and **garrisons**, restrictions on allied
**lawcourts**, **cleruchies** (Athenian settler-garrisons on Euboea, Naxos, Andros), the
demand for offerings at the Athenian **Panathenaea**, and increasingly **proprietorial
language** ("the cities which Athens rules"). The League **council** ceased to meet around
mid-century, and the quota of **one-sixtieth** of the tribute was now paid to **Athena** at
Athens. The climax of the transformation was the abandonment of the League's founding aim —
war against Persia — in the **[[peace-of-callias-449bce|Peace of Callias]]** (c. 449).

## Instruments of empire and the last revolt

After the [[peace-of-callias-449bce|Peace of Callias]] and the
[[thirty-years-peace-446bce|Thirty Years' Peace]], Athens consolidated control with a
standing apparatus, much of it visible only in the inscriptions: **Athenian magistrates and
overseers** (*episkopoi*) in the cities; the transfer of serious **lawsuits** (death,
exile, confiscation) to Athenian courts; the **Coinage Decree** (M–L 45) imposing Athenian
silver coinage, weights and measures on the allies and forbidding their own silver coinage
— part fiscal convenience, part "a political act of a demonstrative nature"; and the
diversion of surplus tribute to the **[[parthenon|Periclean building program]]**, the
charge that Pericles' critics (led by **Thucydides son of Melesias**, ostracized 443) made
against him and that the building accounts confirm. The **Samian revolt** (440–439) — Samos
being one of the last ship-providing allies — was the empire's gravest internal crisis:
...
the economic engine of [[athenian-democracy|Athenian democracy]] (tribute paid the rowers'
wages, the jury pay, and the [[parthenon|Periclean building program]]) and the structural
fact that made the [[peloponnesian-war|Peloponnesian War]] a contest of two incompatible
systems. Its history is also a historiographical problem: Thucydides "concealed his workings"
